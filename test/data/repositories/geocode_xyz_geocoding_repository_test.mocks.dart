...
// in numpang_app/test/data/repositories/geocode_xyz_geocoding_repository_test.dart.
...
import 'package:numpang_app/data/datasources/geocoding_cache.dart' as _i10;
...
/// A class which mocks [GeocodingCache].
///
/// See the documentation for Mockito's code generation for more information.
class MockGeocodingCache extends _i1.Mock implements _i10.GeocodingCache {
  MockGeocodingCache() {
    _i1.throwOnMissingStub(this);
  }

  @override
  String? getReverseGeocode(_i11.LatLng? position) =>
      (super.noSuchMethod(Invocation.method(#getReverseGeocode, [position]))
          as String?);

  @override
  void setReverseGeocode(_i11.LatLng? position, String? address) =>
      super.noSuchMethod(
        Invocation.method(#setReverseGeocode, [position, address]),
        returnValueForMissingStub: null,
      );

  @override
  List<Map<String, dynamic>>? getSearchResults(String? query) =>
      (super.noSuchMethod(Invocation.method(#getSearchResults, [query]))
          as List<Map<String, dynamic>>?);

  @override
  void setSearchResults(String? query, List<Map<String, dynamic>>? results) =>
      super.noSuchMethod(
        Invocation.method(#setSearchResults, [query, results]),
        returnValueForMissingStub: null,
      );
